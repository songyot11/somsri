class User < ApplicationRecord
  ...
  def leave_remaining
    ...
    full_day_leave_count = self.vacations.vacation_full_day.not_rejected.count
    half_day_morning_leave_count = self.vacations.vacation_half_day_morning.not_rejected.count
    half_day_afternoon_leave_count = self.vacations.vacation_half_day_afternoon.not_rejected.count
    ...
    deduce_days += full_day_leave_count * VacationType.vacation_full_day.deduce_days
    deduce_days += half_day_morning_leave_count * VacationType.vacation_half_day_morning.deduce_days
    deduce_days += half_day_afternoon_leave_count * VacationType.vacation_half_day_afternoon.deduce_days
