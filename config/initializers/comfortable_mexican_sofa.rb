...
ComfortableMexicanSofa.configure do |config|
  ...
  config.upload_file_options = {:url => '/system/:class/:id/:attachment/:style/:filename', styles: { menu_item: '175x115>', thumb: '100x100<', medium: '300x300<'}, :s3_permissions => 'public-read' }
  ...
  config.locales = {:en => 'English', :th => 'ไทย'}
